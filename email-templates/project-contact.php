...
<?php 
  if(isset($_POST['email'])){
	...
	<tr>
	<td colspan='2' align='center' valign='top'><img style=' margin-top: 15px; ' src='https://lshyun730.github.io/lsh/images/common/logo-email.png' ></td>
	</tr>
	<tr>
